    ...
    <div class="gray-box">
      ...
      <div class="banner">
        ...
        <div class="num">
          ...
          <buynum @changenum="num11111"></buynum>
        </div>
        <div class="buy">
...
export default {
  ...
  methods: {
    num11111(val) {
      console.log(val); //从子组件里面传递过来的数字值
    },
    handleclick(src) {
      this.big = src;
    },
    async goodsinfo() {
      ...
      let a = res.data.productId;
      let alldata = res.data.data.result;
      let onedata = alldata.find((item) => {
        return item.productId == a;
      });
      this.product = onedata;
